...
<html lang="en">
<head>
  <title>Datasave Frist HTML</title>
  <meta charset="utf-8">
    ...
    <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input type="text" name="container0" id="select1">
          </td>
          <td><input type="number" class="input-area pr price" id="p1" name="container1"></td>
          <td><input type="number" class="input-area pr qty" id="qyt1" name="container2"></td>
          <td><input type="number" name="container3" class="input-area pr total_price" id="totalprice1"></td>
        </tr>
        <tr>
          <td>
          ...
          <!-- <td>
            <input type="text" name="container4" id="select2">
          </td>
          <td><input type="number" class="input-area pr price" id="p2" name="container5"></td>
          <td><input type="number" class="input-area pr qty" id="qyt2" name="container6"></td>
          <td><input type="number" name="container7" class="input-area pr total_price" id="totalprice2"></td> -->
        </tr>
        <tr>
          <!-- <td>
          ...
          <td>
            <input type="text" name="container8" id="select3">
          </td>
          <td><input type="number" class="input-area pr price" id="p3" name="container9"></td>
          <td><input type="number" class="input-area pr qty" id="qyt3" name="container10"></td>
          <td><input type="number" name="container11" class="input-area pr total_price" id="totalprice3"></td>
        </tr>
          <!-- <tr>
          <td><h3>Total</h3></td>
          <td></td>
...
<script src="scriptForHTML.js"></script>
<!-- <script>
  $(document).ready(function(){
  // for(i=0;i<12;i++){
  //  $()
  // }
  $("input[name='container0']").val('$a0');
