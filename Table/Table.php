    ...
    <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
      ...
      <tbody>
        <tr>
          ...
          <td><input type="number" name=""  class="num-input pr total_price" onchange="add_all_total(this)"</td>
        </tr>
        <tr>
        ...
        <tr>
          <td><h3>Total</h3></td>
          <td></td>
          <td><td><input type="number" name=""  class="num-input pr all_total_price"></td></td>
        </tr>
      </tbody>
    </table>
